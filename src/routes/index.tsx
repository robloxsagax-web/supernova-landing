...
// Supernova App URL - single source of truth for all CTA destinations
const SUPERNOVA_APP_URL = "https://appsupernova.vercel.app/auth";
    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4">
      <nav className="glass-strong flex w-full max-w-5xl items-center justify-between rounded-full px-4 py-2 md:px-6">
        ...
        <div className="flex items-center gap-2">
          <a href={SUPERNOVA_APP_URL} className="hidden text-sm text-white/70 hover:text-white sm:inline px-3">Sign in</a>
          <a href={SUPERNOVA_APP_URL} className="btn-premium btn-premium-hover !py-2 !px-4 !text-sm">
...
function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <a href={SUPERNOVA_APP_URL} className="btn-premium btn-premium-hover group">
          Start Creating Free
    ...
    <section id="cta" className="relative z-10 overflow-hidden px-6 py-40">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a href={SUPERNOVA_APP_URL} className="btn-premium btn-premium-hover">
